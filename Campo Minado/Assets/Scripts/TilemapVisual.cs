...
public class TilemapVisual : MonoBehaviour
{
    ...
    {
        public NodeObject.NodeTypes tilemapSprite;
    ...
    private Dictionary<NodeObject.NodeTypes, UVCoords> uvCoordsDictionary;
    ...
    private void Awake()
    {
        ...
        uvCoordsDictionary = new Dictionary<NodeObject.NodeTypes, UVCoords>();
    ...
    public void SetGrid(Grid<NodeObject> grid)
    {
        ...
        grid.OnGridChangedValue += Grid_OnGridValueChanged;
    }
    ...
    private void Grid_OnGridValueChanged(object sender, Grid<NodeObject>.OnGridChangedValueEventArgs e)
    {
        updateMesh = true;
    }
    ...
    private void UpdateHeatMapVisual()
    {
        ...
        for (int x = 0; x < grid.GetWidth(); x++)
        {
            for (int y = 0; y < grid.GetHeight(); y++)
            {
                ...
                if (tilemapSprite == NodeObject.NodeTypes.Empty)
                {
